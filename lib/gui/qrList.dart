...
class MyInherited extends InheritedWidget { // TODO rename inheritedwidget
  MyInherited({
    Key key,
    @required this.child,
...
class _QRList extends State<QRList> {
  ...
  dispose() {
    super.dispose();
    MyInherited.of(context).bloc.dispose();
  }
                          ...
                          child: StreamBuilder(
                            ...
                            builder: (BuildContext context, AsyncSnapshot<List<Item>> snapshot) {
                              if (!snapshot.hasData)
                                ...
                                return ListView(
                                  children: snapshot.data.map(_buildItemEntry).toList(),
